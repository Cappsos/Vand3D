...
from utils.io import load_gt_mask, load_brain_volume, get_best_threshold
...
def plot_anomaly_overlay(original_volume, anomaly_map, gt_mask, save_path, sample_name, temperature):
    ...
    if original_slice.shape != (240, 240):
...
def test_dice3d(args):
    ...
    for idx, items in enumerate(tqdm(test_dataloader)):
        ...
        patient_save_path = os.path.join(f'{save_path}/test', patient_id)
        ...
        if buf["ref_vol"] is None and scale_id == 0 and args.fusion:
